    ...
    public class SmsTestController : ControllerBase
    {
        ...
        public IActionResult GetTemplates()
        {
            ...
            var templates = new List<object>
            {
                ...
                new { name = "AppointmentRejected",              preview = SmsTemplates.AppointmentRejected("Vefa Kuaförü", now.AddDays(2), "Uygun personel yok.") },
                ...
                new { name = "NewAppointmentSummaryForShop",     preview = SmsTemplates.NewAppointmentSummaryForShop(new[] { ("Mehmet Topuz", 2), ("Ozan Çelik", 3) }.ToList<(string Name, int Count)>()) },
                new { name = "NewAppointmentForEmployee",        preview = SmsTemplates.NewAppointmentForEmployee("Ahmet Yılmaz", "Saç Kesimi", now.AddDays(2)) },
                new { name = "AppointmentCancelledByCustomerToEmployee", preview = SmsTemplates.AppointmentCancelledByCustomerToEmployee("Ahmet Yılmaz", "Saç Kesimi", now.AddDays(1)) },
                new { name = "AppointmentCompleted",             preview = SmsTemplates.AppointmentCompleted("Vefa Kuaförü") },
                new { name = "AppointmentReminder48h",           preview = SmsTemplates.AppointmentReminder48h("Vefa Kuaförü", now.AddDays(1)) },
                new { name = "AppointmentReminder2h",            preview = SmsTemplates.AppointmentReminder2h("Vefa Kuaförü", now.AddHours(2)) },
        ...
        public async Task<IActionResult> Send(string templateName, [FromQuery] string phone = "05000000000")
        {
            ...
            var message = templateName switch
            {
                ...
                "AppointmentRejected"           => SmsTemplates.AppointmentRejected("Vefa Kuaförü", now.AddDays(2), "Uygun personel yok."),
                ...
                "NewAppointmentSummaryForShop"  => SmsTemplates.NewAppointmentSummaryForShop(new[] { ("Mehmet Topuz", 2), ("Ozan Çelik", 3) }.ToList<(string Name, int Count)>()),
                "NewAppointmentForEmployee"     => SmsTemplates.NewAppointmentForEmployee("Ahmet Yılmaz", "Saç Kesimi", now.AddDays(2)),
                "AppointmentCancelledByCustomerToEmployee" => SmsTemplates.AppointmentCancelledByCustomerToEmployee("Ahmet Yılmaz", "Saç Kesimi", now.AddDays(1)),
                "AppointmentCompleted"          => SmsTemplates.AppointmentCompleted("Vefa Kuaförü"),
                "AppointmentReminder48h"        => SmsTemplates.AppointmentReminder48h("Vefa Kuaförü", now.AddDays(1)),
                "AppointmentReminder2h"         => SmsTemplates.AppointmentReminder2h("Vefa Kuaförü", now.AddHours(2)),
