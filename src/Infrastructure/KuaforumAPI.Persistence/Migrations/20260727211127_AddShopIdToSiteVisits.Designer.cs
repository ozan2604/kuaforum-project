...
namespace KuaforumAPI.Persistence.Migrations
{
    ...
    [Migration("20260727211127_AddShopIdToSiteVisits")]
    partial class AddShopIdToSiteVisits
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KuaforumAPI.Domain.Entities.AdApplication", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("KuaforumAPI.Domain.Entities.AdminPassword", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("KuaforumAPI.Domain.Entities.Appointment", b =>
                {
                    ...
                    b.Property<bool>("IsReviewReminderSent")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("KuaforumAPI.Domain.Entities.City", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("KuaforumAPI.Domain.Entities.District", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("KuaforumAPI.Domain.Entities.MediaLike", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("MediaItemId", "MediaItemType")
                        .HasDatabaseName("IX_MediaLikes_Item");

                    b.HasIndex("UserId", "MediaItemId", "MediaItemType")
                        .IsUnique()
            ...
            modelBuilder.Entity("KuaforumAPI.Domain.Entities.Neighborhood", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("KuaforumAPI.Domain.Entities.ShopVideoTag", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ShopVideoId");

                    b.ToTable("ShopVideoTags");
                });

            modelBuilder.Entity("KuaforumAPI.Domain.Entities.SiteVisit", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("KuaforumAPI.Domain.Entities.District", b =>
                {
                    b.HasOne("KuaforumAPI.Domain.Entities.City", "City")
                        .WithMany("Districts")
            ...
            modelBuilder.Entity("KuaforumAPI.Domain.Entities.Neighborhood", b =>
                {
                    b.HasOne("KuaforumAPI.Domain.Entities.District", "District")
            ...
            modelBuilder.Entity("KuaforumAPI.Domain.Entities.ShopVideoTag", b =>
                {
                    b.HasOne("KuaforumAPI.Domain.Entities.ShopVideo", "ShopVideo")
                        .WithMany("Tags")
                        .HasForeignKey("ShopVideoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ShopVideo");
                });
